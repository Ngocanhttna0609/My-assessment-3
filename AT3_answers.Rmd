...
#To find the proportion of sites in the sequence we can use the rep command 
...
n_mut_range<-c(0,30,50,80,110,140,170,200,230)
...
#The proportion of sites randomised from the total sequence length of 650bp, 100 repeats using gene 1.
x<-c(0,0.04,0.07,0.12,0.16,0.21,0.26,0.31,0.35)

  #The proportion of successful BLASTs
y<-c(1.00, 1.00, 1.00, 0.98, 0.74, 0.40, 0.18, 0.03, 0.01)
