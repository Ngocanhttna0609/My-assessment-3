...
proportion_plot <- number_mutation / length_seq
plot(propotion_plot, type='l', main = "How proportion of site affects BLAST performance", ylab = "proportion of success", xlab = "proportion of site randomised")
```
